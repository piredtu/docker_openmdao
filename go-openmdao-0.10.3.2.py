...
def adjust_options(options, args):
    ...
    if len(args) == 0:
        args.append('openmdao-%s' % '0.10.3.2')
...
def after_install(options, home_dir, activated=False):
    ...
    reqs = ['Jinja2==2.4', 'Pyevolve==0.6', 'Pygments==1.3.1', 'SetupDocs==1.0.5', 'Sphinx==1.2.2', 'argparse==1.2.1', 'bson==0.3.3', 'cobyla==1.0.1', 'conmin==1.0.1', 'decorator==3.2.0', 'docutils==0.10', 'mock==1.0.1', 'networkx==1.8.1', 'newsumt==1.1.0', 'nose==1.3.3', 'openmdao.examples.bar3simulation==0.10.3.2', 'openmdao.examples.enginedesign==0.10.3.2', 'openmdao.examples.expected-improvement==0.10.3.2', 'openmdao.examples.mdao==0.10.3.2', 'openmdao.examples.nozzle-geometry-doe==0.10.3.2', 'openmdao.examples.simple==0.10.3.2', 'openmdao.lib==0.10.3.2', 'openmdao.main==0.10.3.2', 'openmdao.test==0.10.3.2', 'openmdao.units==0.10.3.2', 'openmdao.util==0.10.3.2', 'ordereddict==1.1', 'pycrypto==2.3', 'pyparsing==1.5.7', 'pytz==2011k', 'requests==2.2.1', 'slsqp==1.0.1', 'traits==4.3.0', 'zope.interface==3.6.1']
    guireqs = ['PyYAML==3.10', 'argh==0.15.1', 'openmdao.gui==0.10.3.2', 'pathtools==0.1.2', 'pyV3D==0.4.4', 'pyzmq==13.1.0', 'tornado==2.2.1', 'watchdog==0.6.0']
